...
describe("Pow", function () {
    ...
    describe('should handle powers of 10', function () {
        ...
        it("should: 10^.2 = 1.58489319246111348520210137339151", function () {
            expect(pow('10', '0.2', 32, undefined)).toBe("1.58489319246111348520210137339151");
        });

        it("should: 10^-.2 = 0.63095734448019324943436013662234", function () {
            expect(pow('10', '-0.2', 32)).toBe("0.63095734448019324943436013662234");
        });

        it("should: 10^-2.2 = 0.00630957344480193249434360136622", function () {
            expect(pow('10', '-2.2', 32)).toBe("0.00630957344480193249434360136622");
        });
