...
describe("BIG-DECIMAL", function () {
  ...
  describe("compareTo", function () {
    ...
    it("should produce 23.678, 67.34= -1", function () {
      expect(new bigDecimal("23.678").compareTo(new bigDecimal("67.34"))).toBe(
        -1
      );
    });
    it("should produce 23.678, -67.34= 1", function () {
    ...
    it("should produce .678, 0.67800= 0", function () {
      expect(new bigDecimal(".678").compareTo(new bigDecimal("0.67800"))).toBe(
        0
      );
    });
  });
  ...
  describe("multiply", function () {
    it("should: -12 * 0 = 0", function () {
      expect(
        new bigDecimal("-12").multiply(new bigDecimal("0")).getValue()
      ).toBe("0");
    });
    ...
    it("should: 12 * 13 = 156", function () {
      expect(
        new bigDecimal("12").multiply(new bigDecimal("13")).getValue()
      ).toBe("156");
    });

    it("should: 13 * 130 = 1690", function () {
      expect(
        new bigDecimal("13").multiply(new bigDecimal("130")).getValue()
      ).toBe("1690");
    });
    ...
    it("should: 0.5 * 0.2 = 0.1", function () {
      expect(
        new bigDecimal("0.5").multiply(new bigDecimal("0.2")).getValue()
      ).toBe("0.1");
    });
    ...
    it("should: .05 * .02 = 0.001", function () {
      expect(
        new bigDecimal(".05").multiply(new bigDecimal(".02")).getValue()
      ).toBe("0.001");
    });
  });
  ...
  describe("divide", function () {
    ...
    it("should: 24 / 120 = 0.2", function () {
      expect(
        new bigDecimal("24").divide(new bigDecimal("120"), 2).getValue()
      ).toBe("0.20");
    });
  });
  ...
  describe("subtract", function () {
    it("should: -12 - 0 = -12", function () {
      expect(
        new bigDecimal("-12").subtract(new bigDecimal("0")).getValue()
      ).toBe("-12");
    });
    it("should: 0 - 12 = -12", function () {
      expect(
        new bigDecimal("0").subtract(new bigDecimal("12")).getValue()
      ).toBe("-12");
    });
    it("should: 12 - 12 = 0", function () {
      expect(
        new bigDecimal("12").subtract(new bigDecimal("12")).getValue()
      ).toBe("0");
    });
